        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pnp.sp.web.lists.getByTitle(listName).items.select(matchColumns).top(topCount).orderBy(orderBy).get()];
                case 1:
                    resultData = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, pnp.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 3:
                    resultData = _a.sent();
                    _a.label = 4;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [2 /*return*/, pnp.sp.web.lists.getByTitle(listName).items.select(matchColumns).expand(Lookupvalue).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 1:
                ...
                case 2:
                    resultData = _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, pnp.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 4:
                    resultData = _a.sent();
                    _a.label = 5;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('common');
                    return [4 /*yield*/, pnp.sp.web.folders.getByName(listName).folders.getByName(folderName).delete()];
                case 1:
                    confirm = _a.sent();
                    console.log(confirm);
