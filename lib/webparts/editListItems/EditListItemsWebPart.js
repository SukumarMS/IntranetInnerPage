...
import { readItems, updateitems, GetQueryStringParams, base64ToArrayBuffer } from '../../commonService';
import 'jquery';
    ...
    EditListItemWebPart.prototype.UpdateItem = function (siteURL, strLocalStorage, strComponentId) {
        ...
        if (strLocalStorage == "Announcements") {
            ...
            if (strcrop == "1" && files.files.length == 0) {
                ...
                var cropchecker = this.imagecropperChecking();
            ...
            if (strcrop == "1" && files.files.length == 0) {
                ...
                if (isAllfield && cropchecker) {
                    $body.addClass("loading");
                    updateitems("News", strComponentId, saveData_1, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                            //window.location.href = "" + siteURL + "/Pages/ListView.aspx?CName=" + strLocalStorage + "";
                ...
                if (isAllfield && cropchecker) {
                    $body.addClass("loading");
                    updateitems("News", strComponentId, saveData_2, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                            //window.location.href = "" + siteURL + "/Pages/ListView.aspx?CName=" + strLocalStorage + "";
            ...
            if (files.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    updateitems("Employee Corner", strComponentId, saveData_3, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                            //window.location.href = "" + siteURL + "/Pages/ListView.aspx?CName=" + strLocalStorage + "";
            ...
            if (($('#cropped-img')[0].src == siteURL + '/_catalogs/masterpage/BloomHomepage/images/prof-img.jpg')) {
                ...
                var isDateChecker = this.EventDateChecker();
                var cropchecker = this.imagecropperChecking();
            ...
            if (files.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    updateitems("Organizational Policies", strComponentId, saveData_4, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
            ...
            if ($('#cropped-img')[0].src == siteURL + '/_catalogs/masterpage/BloomHomepage/images/prof-img.jpg') {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    updateitems("Banners", strComponentId, saveData_5, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                            //window.location.href = "" + siteURL + "/Pages/ListView.aspx?CName=" + strLocalStorage + "";
            ...
            if (files.files.length == 0 && docfiles.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    updateitems("Corporate Discounts", strComponentId, saveData_6, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                            //window.location.href = "" + siteURL + "/Pages/ListView.aspx?CName=" + strLocalStorage + "";
...
//# sourceMappingURL=EditListItemsWebPart.js.map
