define("30a995d1-97ea-48bf-a7dc-f1f153f4ac3a_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","@microsoft/sp-loader","ImageGalleryWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_84__, __WEBPACK_EXTERNAL_MODULE_118__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__microsoft_sp_loader__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__microsoft_sp_loader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__microsoft_sp_loader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings__);
...
var ImageGalleryWebPart = (function (_super) {
    __extends(ImageGalleryWebPart, _super);
    function ImageGalleryWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ImageGalleryWebPart.prototype.render = function () {
        __WEBPACK_IMPORTED_MODULE_3__microsoft_sp_loader__["SPComponentLoader"].loadCss("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css");
    ...
    ImageGalleryWebPart.prototype.checkUserPermissionForDeletion = function () {
        var email = this.context.pageContext.user.loginName;
        var compName = "Image Gallery";
        Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["e" /* checkUserinGroup */])(compName, email, function (result) {
            if (result == 1) {
                $('.deleteFolder').show();
                $('#AddingButtons').show();
            }
    ...
    // DISPLAY ITEMS 
    /****** START ******/
    ImageGalleryWebPart.prototype.getItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("Image Gallery", columnArray, 5000, "ID")];
                    case 1:
                        picItems = _a.sent();
                        ...
                        $('.deleteFolder').hide();
                        Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["e" /* checkUserinGroup */])("Image Gallery", this.context.pageContext.user.loginName, function (result) {
                            if (result == 1) {
                                $(".deleteFolder").show();
                            }
                            else if (result == 0) {
                        ...
                        $('.deleteFolder').click(function (event) {
                            ...
                            alertify.confirm("Are you sure you want to delete selected Folder ?", function (e) {
                                if (e) {
                                    alertify.success("");
                                    Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* DeleteFolder */])("Image Gallery", folderName);
                                    location.reload();
                                }
                                else { }
                            }, function (e) { if (e) {
    ...
    Object.defineProperty(ImageGalleryWebPart.prototype, "dataVersion", {
        /****** END ******/
        get: function () {
    ...
    ImageGalleryWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_4_ImageGalleryWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (ImageGalleryWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=image-gallery-web-part.js.map