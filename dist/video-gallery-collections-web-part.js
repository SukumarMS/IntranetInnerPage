define("88afaf7b-bac1-403b-80ee-f0d2604b32c3_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","bootstrap","@microsoft/sp-loader","VideoGalleryCollectionsWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_83__, __WEBPACK_EXTERNAL_MODULE_84__, __WEBPACK_EXTERNAL_MODULE_129__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__commonJS__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__microsoft_sp_loader__ = __webpack_require__(84);
...
var VideoGalleryCollectionsWebPart = (function (_super) {
    ...
    VideoGalleryCollectionsWebPart.prototype.render = function () {
        __WEBPACK_IMPORTED_MODULE_4__microsoft_sp_loader__["SPComponentLoader"].loadCss("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css");
    ...
    VideoGalleryCollectionsWebPart.prototype.checkUserPermissionForDeletion = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_2__commonJS__["e" /* checkUserinGroup */])(compName, email, function (result) {
            if (result == 1) {
                $('.deleteFolder').show();
                $('#AddingButtons').show();
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_2__commonJS__["j" /* readItems */])("Video Gallery", columnArray, 5000, "ID")];
                    case 1:
                        picItems = _a.sent();
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_2__commonJS__["e" /* checkUserinGroup */])("Video Gallery", this.context.pageContext.user.loginName, function (result) {
                            if (result == 1) {
                        ...
                        $('.deleteFolder').click(function (event) {
                            ...
                            alertify.confirm("Are you sure you want to delete selected Folder ?", function (e) {
                                if (e) {
                                    alertify.success("");
                                    Object(__WEBPACK_IMPORTED_MODULE_2__commonJS__["a" /* DeleteFolder */])("Video Gallery", folderName);
                                    location.reload();
                                }
                                else { }
                            }, function (e) { if (e) {
    ...
    VideoGalleryCollectionsWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_VideoGalleryCollectionsWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (VideoGalleryCollectionsWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=video-gallery-collections-web-part.js.map