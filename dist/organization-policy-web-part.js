define("b8aadadd-92ce-4788-8a41-88f3348dd5b2_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","jplist-core","jplist-pagination","OrganizationPolicyWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_98__, __WEBPACK_EXTERNAL_MODULE_99__, __WEBPACK_EXTERNAL_MODULE_124__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings__);
...
var OrganizationPolicyWebPart = (function (_super) {
    ...
    OrganizationPolicyWebPart.prototype.render = function () {
        var _thatt = this;
        Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["e" /* checkUserinGroup */])("Organizational Policies", this.context.pageContext.user.email, function (result) {
            if (result == 1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dept = "Admin";
                        dept = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " ");
                        strLocalStorage = "";
                        if (strLocalStorage == "") {
                            strLocalStorage = "Organizational%20Policies";
                        }
                        if (!(this.userflag == false)) return [3 /*break*/, 2];
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.filter("Departments eq '" + dept + "' and Display eq 1").top(count).orderBy("Modified").get()];
                    case 1:
                        items = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.filter("Departments eq '" + dept + "'").top(count).orderBy("Modified").get()];
                    case 3:
                        items = _a.sent();
                        _a.label = 4;
                    case 4:
                        if (items.length > 0) {
                            ...
                            for (i = 0; i < items.length; i++) {
                                ...
                                Organ += "<li class='list-item'>" +
                                    ...
                                    "<p class='Modified'><strong>" + Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(items[i].Modified) + "</strong></p>" +
                        ...
                        $(document).on('change', '.switch-input', function () {
                            ...
                            if (_thisid.prop("checked")) {
                                ...
                                var item = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])("Organizational%20Policies", id, myobj);
    ...
    OrganizationPolicyWebPart.prototype.Depart = function () {
        var _this = this;
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["b" /* GetQueryStringParams */])("CName");
        if (strLocalStorage === undefined) {
            strLocalStorage = "Organizational%20Policies";
        }
        var DepName = "";
        __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.web.lists.getByTitle(strLocalStorage).items.get()
            .then(function (items) {
            if (items.length > 0) {
    ...
    OrganizationPolicyWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_4_OrganizationPolicyWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (OrganizationPolicyWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=organization-policy-web-part.js.map