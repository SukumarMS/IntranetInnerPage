define("8abac69e-0ad3-4cbe-9385-3416b7e6ef93_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","jplist-core","jplist-pagination","ListviewWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_98__, __WEBPACK_EXTERNAL_MODULE_99__, __WEBPACK_EXTERNAL_MODULE_112__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return addItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return readItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return readItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return deleteItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return updateItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DeleteFolder; });
/* unused harmony export GetFolder */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return formString; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return batchDelete; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return formatDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return GetQueryStringParams; });
...
function addItems(listName, listColumns) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.add(listColumns)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function additemsattachment(listName, file, listColumns) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(listName).files.add(file.name, file, true)];
                case 1:
                    result = _a.sent();
                    result.file.listItemAllFields.get().then(function (listItemAllFields) {
                        __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(listItemAllFields.Id).update(listColumns);
                    });
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).top(topCount).orderBy(orderBy).get()];
                case 1:
                    resultData = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 3:
                    resultData = _a.sent();
                    _a.label = 4;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [2 /*return*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).expand(Lookupvalue).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 1:
                ...
                case 2:
                    resultData = _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get()];
                case 4:
                    resultData = _a.sent();
                    _a.label = 5;
...
function updateItem(listName, id, listColumns) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(id).update(listColumns)];
                case 1:
                    result = _a.sent();
...
function deleteItem(listName, itemID) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(itemID).delete()];
...
function GetFolder(listName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.folders.getByName(listName).folders.expand('ListItemAllFields').get()];
                case 1:
                    folderList = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('common');
                    return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.folders.getByName(listName).folders.getByName(folderName).delete()];
                case 1:
                    confirm = _a.sent();
                    console.log(confirm);
...
function batchDelete(listName, selectedArray, siteURL) {
    return __awaiter(this, void 0, void 0, function () {
        var web, batch, arrayLen, i;
        return __generator(this, function (_a) {
            web = new __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__["Web"](siteURL);
            ...
            batch.execute().then(function (items) {
                if (listName == 'Holiday') {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_sp_pnp_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commonJS__ = __webpack_require__(82);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ListviewWebPart = (function (_super) {
    ...
    ListviewWebPart.prototype.render = function () {
        var _this = this;
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " ");
        //Checking user details in group
        Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["e" /* checkUserinGroup */])(strLocalStorage, this.context.pageContext.user.email, function (result) {
            //console.log(result);
            if (result == 1) {
                _this.userflag = true;
            }
    ...
    ListviewWebPart.prototype.viewlistitemdesign = function () {
        ...
        this.ViewListItems(Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " "));
    ...
    ListviewWebPart.prototype.ViewListItems = function (strLocalStorage) {
        ...
        if (this.userflag == false) {
            if (strLocalStorage == "Holiday") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "EventDate", "EndEventDate", "Display"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Announcements") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Expires", "Modified", "Image", "Explanation", "Expires", "Display", "ViewedUsers"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Banners") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Image", "BannerContent", "Display"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Quick Links") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "LinkURL", "Display"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "News") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Date", "Modified", "Image", "Display", "Explanation"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Employee Corner") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "DocumentFile", "File_x0020_Type"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Events") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "Explanation", "HyperLink", "StartDate", "EndDate"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
                ...
                objResults = __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Polls").items.select("ID", "Title", "Modified", "Display", "Question", "Options", "IsDeleted").filter("IsDeleted eq 0").top(100).get();
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Corporate Discount") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "SiteLink"], count, "Modified", "Display", 1);
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            ...
            if (strLocalStorage == "Holiday") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "EventDate", "EndEventDate", "Display"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Announcements") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Expires", "Modified", "Image", "Explanation", "Expires", "Display"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Banners") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Image", "BannerContent", "Display"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Quick Links") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "LinkURL"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "News") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Date", "Modified", "Display", "Image", "Explanation"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Employee Corner") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "DocumentFile", "File_x0020_Type"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Events") {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "Explanation", "HyperLink", "StartDate", "EndDate"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
            else if (strLocalStorage == "Polls") {
                objResults = __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Polls").items.select("ID", "Title", "Modified", "Display", "Question", "Options", "IsDeleted").filter("IsDeleted eq 0").top(count).get();
                ...
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display", "SiteLink"], count, "Modified");
                objResults.then(function (items) {
                    _this.renderhtml(items, strLocalStorage);
                });
            }
    ...
    ListviewWebPart.prototype.displaypollcheck = function () {
        __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Polls").items.select("ID", "Display").filter("Display eq 1").top(100).get().then(function (items) {
    ...
    ListviewWebPart.prototype.renderhtml = function (objResults, strLocalStorage) {
        ...
        if (strLocalStorage == 'Holiday') {
            for (var i = 0; i < objResults.length; i++) {
                ...
                $('.displaydate' + i).append("<strong>" + Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].EventDate) + "</strong>");
                var eedate = "";
                if ((objResults[i].EndEventDate) != null) {
                    eedate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].EndEventDate);
                }
                var edate = "";
                if ((objResults[i].EventDate) != null) {
                    edate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].EventDate);
                }
                if (eedate == "" && edate == "") {
            ...
            var _loop_1 = function (i) {
                ...
                if ((objResults[i].Expires) != null) {
                    eedate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].Expires);
                }
                ...
                if (this_1.userflag == false) {
                    ...
                    objResults1 = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("AnnouncementComments", ["AnnouncementID"], 1000, "Modified", "AnnouncementID", objResults[i].ID);
                    ...
                    objResults2 = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])("AnnouncementsLikes", ["AnnouncementID", "Liked"], 1000, "Modified", "AnnouncementID", objResults[i].ID);
            ...
            for (var i = 0; i < objResults.length; i++) {
                ...
                if ((objResults[i].Date) != null) {
                    eedate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].Date);
                }
                $('.displaydate' + i).append("<strong>" + eedate + "</strong>");
            }
        }
            ...
            for (var i = 0; i < objResults.length; i++) {
                ...
                if ((objResults[i].EndDate) != null) {
                    eedate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].EndDate);
                }
                var edate = "";
                if ((objResults[i].StartDate) != null) {
                    edate = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].StartDate);
                }
                if (objResults[i].Explanation != null && objResults[i].Explanation.length > 160) {
                    objResults[i].Explanation = objResults[i].Explanation.substring(0, 160) + "...";
                }
                ...
                $('.displaydate' + i).append("<strong>" + Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["h" /* formatDate */])(objResults[i].Modified) + "</strong>");
            }
            ...
            if (strLocalStorage == 'Polls') {
                ...
                alertify.confirm('Confirmation', strconfirm, function () {
                    $('.switch-input:checked').each(function () {
                        ...
                        var item = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])(strLocalStorage, changeid, myobj);
                        ...
                        var item1 = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])(strLocalStorage, id, myobj1);
                ...
                objResults = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["j" /* readItems */])(strLocalStorage, ["ID", "Title", "Modified", "Display"], 5000, "Modified", "Display", 1);
                objResults.then(function (items) {
                    if (items.length < 3 && _thisid.prop("checked")) {
                        ...
                        _thisid.next().text("Displayed");
                        _thisid.prop('checked', true);
                        var item = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["k" /* updateItem */])(strLocalStorage, id, myobj);
                        item.then(function (items) {
        ...
        if (deleteitemID.length > 0 && strLocalStorage == "Polls") {
            ...
            alertify.confirm('Confirmation', strconfirm, function () {
                ...
                for (var k = 0; k < deleteitemID.length; k++) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("Polls").items.getById(delID).update({
                        IsDeleted: true
                    }).then(function () {
                        __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("PollsResults").items.filter("QuestionID eq '" + delID + "'").get().then(function (items) {
                            if (items.length > 0) {
                                for (var i = 0; i < items.length; i++) {
                                    __WEBPACK_IMPORTED_MODULE_4_sp_pnp_js___default.a.sp.web.lists.getByTitle("PollsResults").items.getById(items[i].ID).update({
                                        IsDeleted: true
                                    });
                                }
                                // 
            ...
            alertify.confirm('Confirmation', strconfirm, function () {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["d" /* batchDelete */])(strLocalStorage, selectedArray, _that.context.pageContext.web.absoluteUrl);
    ...
    ListviewWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_ListviewWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (ListviewWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=listview-web-part.js.map