define("3ca92102-a9d8-416d-87e5-e61409c90814_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","jplist-core","jplist-pagination","CorporateDiscountWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_98__, __WEBPACK_EXTERNAL_MODULE_99__, __WEBPACK_EXTERNAL_MODULE_127__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__commonJS__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sp_pnp_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sp_pnp_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_sp_pnp_js__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var CorporateDiscountWebPart = (function (_super) {
    ...
    CorporateDiscountWebPart.prototype.render = function () {
        ...
        var _thatt = this;
        Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["e" /* checkUserinGroup */])("Corporate Discounts", this.context.pageContext.user.email, function (result) {
            if (result == 1) {
    ...
    CorporateDiscountWebPart.prototype.CorDis = function (searchText) {
        ...
        if (searchText && this.userflag) {
            objResults = __WEBPACK_IMPORTED_MODULE_5_sp_pnp_js___default.a.sp.web.lists.getByTitle("Corporate%20Discounts").items.select("ID", "Title", "Modified", "VendorLogo", "SiteLink", "Display").filter(("Title eq '" + searchText + "'") || "SiteLink eq '" + searchText + "'").top(100).get();
            ...
            objResults = __WEBPACK_IMPORTED_MODULE_5_sp_pnp_js___default.a.sp.web.lists.getByTitle("Corporate%20Discounts").items.select("ID", "Title", "Modified", "VendorLogo", "SiteLink", "Display").filter("(Display eq '1' and Title eq '" + searchText + "' )" || "SiteLink eq '" + searchText + "'").top(100).get();
        }
        else {
            if (this.userflag == false) {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["j" /* readItems */])("Corporate%20Discounts", ["ID", "Title", "Modified", "VendorLogo", "SiteLink", "Display"], count, "Modified", "Display", 1);
            }
            else {
                objResults = Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["j" /* readItems */])("Corporate%20Discounts", ["ID", "Title", "Modified", "VendorLogo", "SiteLink", "Display"], count, "Modified");
            }
        }
        objResults.then(function (items) {
            ...
            if (items.length > 0) {
                for (var i = 0; i < items.length; i++) {
                    ...
                    Corporate += "<li class='list-item'>" +
                        ...
                        "</div>" +
                        "<p class='Modified'><strong>" + Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["h" /* formatDate */])(items[i].Modified) + "</strong></p>" +
            ...
            $(document).on('change', '.switch-input', function () {
                ...
                if (_thisid.prop("checked")) {
                    ...
                    var item = Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["k" /* updateItem */])("Corporate%20Discounts", id, myobj);
    ...
    CorporateDiscountWebPart.prototype.deleteitems = function () {
        ...
        if (deleteitemID.length > 0) {
            ...
            alertify.confirm('Confirmation', strconfirm, function () {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_4__commonJS__["d" /* batchDelete */])(strLocalStorage, selectedArray, _that.context.pageContext.web.absoluteUrl);
                //}
                //location.reload();
    ...
    CorporateDiscountWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_CorporateDiscountWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (CorporateDiscountWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=corporate-discount-web-part.js.map