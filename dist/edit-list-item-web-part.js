define("cfaab336-ed0e-41ef-b420-ece0a2346bd4_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","bootstrap","@microsoft/sp-loader","EditListItemWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_83__, __WEBPACK_EXTERNAL_MODULE_84__, __WEBPACK_EXTERNAL_MODULE_114__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var lists_1 = __webpack_require__(15);
var pnp_1 = __webpack_require__(19);
/**
...
(function ( $ ) {
    ...
    $.fn.richText = function( options ) {
        ...
        var $editor,
            ...
            $btnImageUpload = $('<a />', {class: "richText-btn", "title": settings.translations.addImage, html: '<span class="fa fa-image" style="display:none"></span>'}), // image
            $btnVideoEmbed = $('<a />', {class: "richText-btn", "title": settings.translations.addVideo, html: '<span class="fa fa-video-camera fa-video" style="display:none"></span>'}), // video
            $btnFileUpload = $('<a />', {class: "richText-btn", "title": settings.translations.addFile, html: '<span class="fa fa-file-text-o far fa-file-alt" style="display:none"></span>'}), // file
            $btnURLs = $('<a />', {class: "richText-btn", "title": settings.translations.addURL, html: '<span class="fa fa-link" style="display:none"></span>'}), // urls/links
            $btnTable = $('<a />', {class: "richText-btn", "title": settings.translations.addTable, html: '<span class="fa fa-table" style="display:none"></span>'}), // table
          	$btnRemoveStyles = $('<a />', {class: "richText-btn", "data-command": "removeFormat", "title": settings.translations.removeStyles, html: '<span class="fa fa-recycle" style="display:none"></span>'}), // clean up styles
            $btnCode = $('<a />', {class: "richText-btn", "data-command": "toggleCode", "title": settings.translations.code, html: '<span class="fa fa-code" style="display:none"></span>'}); // code
        ...
        function init() {
            ...
            $editor.append(
                $('<div />', {class: 'richText-toolbar'})
                    .append($('<a />', {class: 'richText-undo is-disabled', html: '<span class="fa fa-undo" style="display:none"></span>', 'title': settings.translations.undo}))
                    .append($('<a />', {class: 'richText-redo is-disabled', html: '<span class="fa fa-repeat fa-redo" style="display:none"></span>', 'title': settings.translations.redo}))
 ...
 */
!function(t){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(46)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
 ...
 */
!function(a){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(46)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return readItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return addItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return base64ToArrayBuffer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return additemsimage; });
/* unused harmony export additemsattachment */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return updateitems; });
/* unused harmony export batchDelete */
/* unused harmony export formString */
/* unused harmony export formatDate */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return checkUserinGroup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GetQueryStringParams; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__ = __webpack_require__(19);
...
function readItems(listName, listColumns, topCount, orderBy, filterKey, filterValue) {
    ...
    if (filterKey == undefined) {
        return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).top(topCount).orderBy(orderBy).get();
    }
    else {
        return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("" + filterKey + " eq '" + filterValue + "'").top(topCount).orderBy(orderBy).get();
    }
}
function addItems(listName, listColumns, callback) {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.add(listColumns).then(function (r) { return callback(r); });
}
function additemsattachment(listName, file, listColumns, callback) {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(listName).files.add(file.name, file, true)
        .then(function (result) {
        result.file.listItemAllFields.get().then(function (listItemAllFields) {
            return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(listItemAllFields.Id).update(listColumns).then(function (r) { return callback(r); });
        });
    });
}
function additemsimage(listName, filename, file, listColumns, callback) {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(listName).files.add(filename, file, true)
        .then(function (result) {
        result.file.listItemAllFields.get().then(function (listItemAllFields) {
            return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(listItemAllFields.Id).update(listColumns).then(function (r) { return callback(r); });
        });
...
function updateitems(listName, id, listColumns, callback) {
    return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(id).update(listColumns).then(function (r) { return callback(r); });
}
var batch;
function batchDelete(listName, selectedArray, callback) {
    batch = __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.createBatch();
    for (var i = 0; i < selectedArray.length; i++) {
        __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(selectedArray[i]).inBatch(batch).delete().then(function (r) {
            console.log(r);
        });
    }
    callback(batch);
...
function checkUserinGroup(Componentname, email, callback) {
    var myitems;
    __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.siteUsers
        .getByEmail(email)
        .groups.get()
        .then(function (items) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(30), __webpack_require__(105)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_croppie__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_sp_pnp_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ExternalRef_css_cropper_min_css__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ExternalRef_css_cropper_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__ExternalRef_css_cropper_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_cropper_css__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_cropper_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__ExternalRef_css_cropper_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_richtext_min_css__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_richtext_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__ExternalRef_css_richtext_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_js_cropper_main_js__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ExternalRef_js_cropper_main_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__ExternalRef_js_cropper_main_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ExternalRef_js_cropper_min_js__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ExternalRef_js_cropper_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__ExternalRef_js_cropper_min_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ExternalRef_css_bootstrap_datepicker_min_css__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ExternalRef_css_bootstrap_datepicker_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__ExternalRef_css_bootstrap_datepicker_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__commonService__ = __webpack_require__(97);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EditListItemWebPart = (function (_super) {
    ...
    EditListItemWebPart.prototype.render = function () {
        __WEBPACK_IMPORTED_MODULE_5__microsoft_sp_loader__["SPComponentLoader"].loadCss('https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.3/croppie.css');
        var _this = this;
        Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["e" /* checkUserinGroup */])("Admin", this.context.pageContext.user.email, function (result) {
            if (result == 1) {
    ...
    EditListItemWebPart.prototype.loadEditComponent = function () {
        var _this = this;
        this.siteURL = this.context.pageContext.web.absoluteUrl;
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CName");
        strLocalStorage = strLocalStorage.split('%20').join(' ');
        var strLocalStorageBreadcrumb = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CName");
        ...
        document.getElementById("ComponentName").innerHTML = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CName").split("%20").join(" ");
        var strComponentId = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CID");
        this.renderhtml(strComponentId);
        var Addevent = document.getElementById('UpdateItem');
        Addevent.addEventListener("click", function (e) { return _this.UpdateItem(_this.siteURL, strLocalStorage, strComponentId); });
        ...
        function readURL(input, width, height) {
            if (input.files && input.files[0] && input.files.length == 1) {
                ...
                reader.onload = function (e) {
                    ...
                    var resize = new __WEBPACK_IMPORTED_MODULE_3_croppie__($('#my-image')[0], {
                        //enableExif: true,
    ...
    EditListItemWebPart.prototype.datepickerkeyTypeBlocker = function () {
        $("#txtExpires,#txtStartDate,#txtEndDate,#txtEvDate,#txtEEDate").keypress(function (event) {
            event.preventDefault();
        });
    };
    EditListItemWebPart.prototype.DateChecker = function () {
    ...
    EditListItemWebPart.prototype.EventDateChecker = function () {
        if ($('#txtEndDate').val() == "") {
            return true;
        }
    ...
    EditListItemWebPart.prototype.announcementsValidtion = function () {
    ...
    EditListItemWebPart.prototype.holidaysValidtion = function () {
    ...
    EditListItemWebPart.prototype.quickLinksValidation = function () {
    ...
    EditListItemWebPart.prototype.nullDateValidate = function (nullDate) {
    ...
    EditListItemWebPart.prototype.newsValidation = function () {
        if (!$('#txtExpires').val()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Select the Date");
            return false;
    ...
    EditListItemWebPart.prototype.quickReadsValidation = function () {
        if (!$('#txtTitle').val().trim()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Enter Title");
            return false;
    ...
    EditListItemWebPart.prototype.eventsValidation = function () {
        if (!$('#txtTitle').val().trim()) {
            alertify.set('notifier', 'position', 'top-right');
    ...
    EditListItemWebPart.prototype.orgpolicyValidation = function (isAllfield) {
        if (!$('#txtTitle').val().trim()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Enter Title");
            isAllfield = false;
    ...
    EditListItemWebPart.prototype.pollsValidation = function () {
    ...
    EditListItemWebPart.prototype.corporationValidation = function () {
        var regexp = /^(https?|s?ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i;
        if (!$("#txtTitle").val().trim()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Enter the Title");
    ...
    EditListItemWebPart.prototype.UpdateItem = function (siteURL, strLocalStorage, strComponentId) {
        var $body = $('body');
        if ($('.ajs-message').length > 0) {
            $('.ajs-message').remove();
        }
        var that = this;
        var strcrop = localStorage.getItem("crop");
        var count;
        var objResults;
        var $body = $("body");
        var isAllfield = true;
        if (strLocalStorage == "Announcements") {
            ...
            if (strcrop == "1" && files.files.length == 0) {
                ...
                if (isAllfield) {
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Announcements", strComponentId, saveData, function (e) {
                        if (e.data) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Announcements", strComponentId, saveDatas, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
                ...
                if (isAllfield) {
                    ...
                    var blob = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["d" /* base64ToArrayBuffer */])(file1[1]);
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("PublishingImages").files.add(file.name, blob, true)
                        .then(function (result) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Announcements").items.getById(strComponentId).update({
                            ID: strComponentId,
            ...
            var isDateChecker = this.DateChecker();
            if (isAllfield && isDateChecker) {
                $body.addClass("loading");
                Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Holiday", strComponentId, myobjHol, function (e) {
                    if (e.data) {
                        $body.removeClass("loading");
                        that.pageBack();
                    }
            ...
            if (isAllfield) {
                $body.addClass("loading");
                isAllfield = this.quickLinksValidation();
                Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Quick Links", strComponentId, myobjQl, function (e) {
                    if (e.data) {
                        $body.removeClass("loading");
                        that.pageBack();
                    }
            ...
            if (files.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Employee Corner", strComponentId, saveData_1, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
                ...
                if (isAllfield) {
                    ...
                    $body.addClass("loading");
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Shared Documents").files.add(file_1.name, file_1, true)
                        .then(function (result) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Employee Corner").items.getById(strComponentId).update({
                            ID: strComponentId,
                            Title: $("#txtTitle").val(),
                            DocumentFile: {
                                "__metadata": {
            ...
            if (($('#cropped-img')[0].src == siteURL + '/_catalogs/masterpage/BloomHomepage/images/prof-img.jpg')) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Events", strComponentId, saveEvents, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            window.history.back();
                        }
                ...
                if (isAllfield) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("PublishingImages").files.add(file.name, blob, true)
                        .then(function (result) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Events").items.getById(strComponentId).update({
                            ID: strComponentId,
                            Title: $("#txtTitle").val().trim(),
            ...
            if (files.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Organizational Policies", strComponentId, saveData_2, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
                ...
                if (isAllfield) {
                    var fileURL = window.location.origin;
                    $body.addClass("loading");
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Shared Documents").files.add(file.name, file, true)
                        .then(function (result) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Organizational Policies").items.getById(strComponentId).update({
                            ID: strComponentId,
                            Title: $("#txtTitle").val(),
                            Explanation: $('.richText-editor').html(),
                            DocumentFile: {
            ...
            if (isAllfield) {
                if (files.files.length == 0) {
                    ...
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Banners", strComponentId, myobjBanners, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
                    ...
                    var fileURL = window.location.origin;
                $body.addClass("loading");
                __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Images").files.add(uniquename, blob, true)
                    .then(function (result) {
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Banners").items.getById(strComponentId).update({
                        ID: strComponentId,
                        Title: $("#txtTitle").val(),
                        BannerContent: $('.richText-editor').html(),
                        Image: {
            ...
            if (this.qustion_lenght == updatequs && this.answer_lenght == updateans) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Polls", strComponentId, myobjPols, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
            ...
            if (this.qustion_lenght != updatequs || this.answer_lenght != updateans) {
                __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("PollsResults").items.filter("QuestionID eq '" + strComponentId + "'").get().then(function (items) {
                    for (var i = 0; i < items.length; i++) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("PollsResults").items.getById(items[i].ID).delete().then(function (result) {
                            var myobjPols = {
                                Question: $("#txtQuestion").val(),
                                Options: $("#txtOptions").val(),
                                IsVisibles: $('#anonymous').prop('checked')
            ...
            var fileURL = window.location.origin;
            var docfiles = document.getElementById("uploadFile");
            var docfile_1 = docfiles.files[0];
            var files = document.getElementById("inputImage");
            var file = files.files[0];
            if (files.files.length == 0 && docfiles.files.length == 0) {
                ...
                if (isAllfield) {
                    $body.addClass("loading");
                    Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["g" /* updateitems */])("Corporate Discounts", strComponentId, saveData_3, function (e) {
                        if (e.data) {
                            $body.removeClass("loading");
                            that.pageBack();
                        }
                ...
                __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("PublishingImages").files.add(file.name, blob, true)
                    .then(function (result) {
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("Shared Documents").files.add(docfile_1.name, docfile_1, true)
                        .then(function (datafile) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Corporate Discounts").items.getById(strComponentId).update({
                            ID: strComponentId,
                            Title: $("#txtTitle").val(),
                            SiteLink: {
                                "__metadata": {
                ...
                if (isAllfield) {
                    ...
                    var file1 = $('#cropped-img').attr('src').split("base64,");
                    var blob = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["d" /* base64ToArrayBuffer */])(file1[1]);
                    __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl("PublishingImages").files.add(uniquename, blob, true)
                        .then(function (result) {
                        __WEBPACK_IMPORTED_MODULE_6_sp_pnp_js___default.a.sp.web.lists.getByTitle("Corporate Discounts").items.getById(strComponentId).update({
                            ID: strComponentId,
                            Title: $("#txtTitle").val(),
    ...
    EditListItemWebPart.prototype.renderhtml = function (strComponentId) {
        ...
        var strLocalStorage = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CName");
        strLocalStorage = strLocalStorage.split('%20').join(' ');
        var strComponentMode = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["a" /* GetQueryStringParams */])("CMode");
    ...
    EditListItemWebPart.prototype.bindorgDept = function () {
        var objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Departments", ["ID", "Departments"], 1000, "Modified", "Display", 1);
    ...
    EditListItemWebPart.prototype.getListItems = function (strComponentId) {
        ...
        var objResults;
        if (strLocalStorage == "Announcements") {
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Announcements", ["Title", "Explanation", "Expires", "Image", "Display"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#cropped-img').attr("src", items[0].Image.Url);
                $('#txtTitle').val(items[0].Title);
                var eedate = "";
                if ((items[0].Expires) != null) {
                    eedate = _this.nullDateValidate(items[0].Expires);
                }
            ...
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Holiday", ["Title", "Modified", "EventDate", "EndEventDate", "Display"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#txtTitle').val(items[0].Title);
                var eedate = "";
                if ((items[0].EventDate) != null) {
                    eedate = _this.nullDateValidate(items[0].EventDate);
                }
                $('#txtEvDate').datepicker('setDate', new Date(eedate));
                if ((items[0].EndEventDate) != null) {
                    eedate = _this.nullDateValidate(items[0].EndEventDate);
                }
                $('#txtEEDate').datepicker('setDate', new Date(eedate));
            });
        }
        else if (strLocalStorage == "News") {
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("News", ["Title", "Modified", "Date", "Image", "Explanation", "Display",], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                ...
                if ((items[0].Date) != null) {
                    eedate = _this.nullDateValidate(items[0].Date);
                }
                $('#txtExpires').datepicker('setDate', new Date(eedate));
            });
        }
        else if (strLocalStorage == "Quick Links") {
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Quick Links", ["Title", "Modified", "LinkURL", "Display"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#txtTitle').val(items[0].Title);
            ...
            debugger;
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Employee Corner", ["Title", "Modified", "Icon", "DocumentFile", "Display"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#txtTitle').val(items[0].Title);
                var strfileType = items[0].DocumentFile.Url.substring(items[0].DocumentFile.Url.lastIndexOf(".") + 1);
                var ftype = _this.siteURL + "/_catalogs/masterpage/BloomHomepage/images/";
            ...
            this.bindorgDept();
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Organizational Policies", ["ID", "Title", "Departments", "Modified", "DocumentFile", "Explanation",], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
            ...
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Banners", ["Title", "Modified", "BannerContent", "Display", "LinkURL", "Order", "Image"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#cropped-img').attr("src", items[0].Image.Url);
                $('#txtTitle').val(items[0].Title);
            ...
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Corporate Discounts", ["Title", "Modified", "VendorLogo", "SiteLink", "DocumentFile"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
            ...
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Events", ["Title", "Modified", "StartDate", "EndDate", "Image", "Explanation"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                $('#cropped-img').attr("src", items[0].Image.Url);
                $('#txtTitle').val(items[0].Title);
                $('.richText-editor').html(items[0].Explanation);
                ...
                if ((items[0].StartDate) != null) {
                    sdate = _this.nullDateValidate(items[0].StartDate);
                }
                $('#txtStartDate').datepicker('setDate', new Date(sdate));
                if ((items[0].EndDate) != null) {
                    eedate = _this.nullDateValidate(items[0].EndDate);
                }
            ...
            objResults = Object(__WEBPACK_IMPORTED_MODULE_13__commonService__["f" /* readItems */])("Polls", ["ID", "Title", "Modified", "Display", "Question", "Options", "IsVisibles"], count, "Modified", "ID", strComponentId);
            objResults.then(function (items) {
                _this.qustion_lenght = items[0].Question.length;
                _this.answer_lenght = items[0].Options.length;
    ...
    EditListItemWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_4_EditListItemWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (EditListItemWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=edit-list-item-web-part.js.map