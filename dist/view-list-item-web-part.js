define("1a3aabeb-38ed-49de-abdf-a61793ef955f_0.0.1", ["jquery","@microsoft/sp-webpart-base","@microsoft/sp-core-library","ViewListItemWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_116__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ExternalRef_css_richtext_min_css__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ExternalRef_css_richtext_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__ExternalRef_css_richtext_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__commonJS__ = __webpack_require__(82);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ViewListItemWebPart = (function (_super) {
    ...
    ViewListItemWebPart.prototype.render = function () {
        var listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " ");
    ...
    ViewListItemWebPart.prototype.FetchListItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " ");
                        ItemID = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CID");
                        columnArray = this.GetColumns(listName);
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["j" /* readItems */])(listName, columnArray, 1, "Modified", "ID", ItemID)];
                    case 1:
    ...
    ViewListItemWebPart.prototype.renderhtml = function () {
        ...
        if (listName == "Banners") {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["e" /* checkUserinGroup */])(listName, Email, function (result) {
                console.log(result);
                if (result == 1) {
    ...
    ViewListItemWebPart.prototype.SubmitComments = function () {
        ...
        if (this.AnnouncementValidation()) {
            var ItemID = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CID");
            var listName = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CName").replace("%20", " ");
            ...
            if (txtAnnounceDesc != 0) {
                ...
                var AddComments = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["c" /* addItems */])("AnnouncementComments", myobjHol);
    ...
    ViewListItemWebPart.prototype.GetComments = function (filterKey) {
        ...
        var GetComments = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["i" /* readItem */])("AnnouncementComments", Columns, 50, "Modified", "AnnouncementID", ItemID, "Editor");
        var Html = "";
        var HtmlDelComments = "";
        var _this = this;
    ...
    ViewListItemWebPart.prototype.DeleteComments = function (id) {
        ...
        alertify.confirm('Confirmation', strconfirm, function () {
            ...
            var DeleteListItems = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["f" /* deleteItem */])("AnnouncementComments", CommentItemID);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        matchColumns = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["g" /* formString */])(Columns);
                        filterValue = this.context.pageContext.user.email;
                        CommentItemID = parseInt(ItemID, 10);
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).filter("User eq '" + filterValue + "' and AnnouncementID eq '" + ItemID + "'").top(1).orderBy("Modified").get()];
                    case 1:
                        GetLikes = _a.sent();
                        ...
                        AddLikes = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["c" /* addItems */])(listName, myobjHol);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["k" /* updateItem */])(listName, GetLikes[0].ID, myobjHol)];
                    case 3:
                        updateLikes = _a.sent();
                        if (updateLikes.data) {
                            $('#divHeartCheck').removeClass("heart-check");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        matchColumns = Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["g" /* formString */])(Columns);
                        Html = "";
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.select(matchColumns).expand("Editor").filter("AnnouncementID eq '" + ItemID + "' and Liked eq 1").orderBy("Modified").get()];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ItemID = parseInt(Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["b" /* GetQueryStringParams */])("CID"));
                        _this = this;
                        $body = $("body");
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3_sp_pnp_js___default.a.sp.site.rootWeb.ensureUser(Email).then(function (result) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__commonJS__["k" /* updateItem */])("Announcements", ItemID, myobjHol)];
                    case 3:
    ...
    ViewListItemWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_1__microsoft_sp_webpart_base__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_2_ViewListItemWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (ViewListItemWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=view-list-item-web-part.js.map